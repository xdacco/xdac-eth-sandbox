...
cleos create account eosio test1 $owner_pubkey $test1_pubkey
cleos create account eosio test2 $owner_pubkey $test2_pubkey
...
cleos transfer eosio.token test1 '1000 SYS'
cleos transfer eosio.token test2 '1000 SYS'
...
# XDAC (user-issued main token)
cleos push action eosio.token create\
  '{"issuer":"eosio.token", "maximum_supply": "1000000000.000 XDAC"}' -p eosio.token@active
cleos push action eosio.token issue\
  '{"to":"eosio.token", "quantity": "1000000000.000 XDAC", "memo": "issue"}' -p eosio.token@active

cleos transfer eosio.token test1 '100000 XDAC'
cleos transfer eosio.token test2 '100000 XDAC'
cleos transfer eosio.token inita '100000 XDAC'
cleos transfer eosio.token initb '100000 XDAC'
cleos transfer eosio.token initc '100000 XDAC'
